...
@section('content')
    ...
    <x-core.page-header title="គ្រប់គ្រងឆមាស (Terms)" />
    <div class="space-y-4">
        <div class="flex flex-col md:flex-row md:items-center justify-between gap-4">
            <div class="relative w-full md:w-96 group">
                ...
                <input id="termSearchInput" type="text"
                    ...
                    placeholder="Search term code or name..." autocomplete="off" />
            </div>
                ...
                <table class="w-full text-sm text-left text-neutral-500 dark:text-neutral-400 border-collapse">
                    <thead class="sticky top-0 z-20 text-xs text-neutral-700 uppercase bg-neutral-50 dark:bg-neutral-800/50 dark:text-neutral-300 backdrop-blur-md">
                        <tr>
                            ...
                            <th scope="col" class="px-6 py-4">Academic Year</th>
                    ...
                    <tbody id="term-table-body" class="divide-y divide-neutral-200 dark:divide-white/5">
                        <tr>
    ...
    @include('term.partials.termModal')
@endsection

@push('scripts')
    @vite(['resources/js/term/term.js'])
@endpush
