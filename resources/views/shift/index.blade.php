...
@section('content')
    ...
    <x-core.page-header title="គ្រប់គ្រងវេនសិក្សា" />
    ...
    <div class="space-y-4">
        <div class="flex flex-col md:flex-row md:items-center justify-between gap-4">
            <div class="relative w-full md:w-96 group">
                ...
                <form id="shiftSearchForm" method="GET" action="{{ route('shift.index') }}"
                    ...
                    <input id="shiftSearchInput" type="text" name="search" value="{{ request('search') }}"
            ...
            <div class="flex items-center gap-2">
                ...
                <x-ui.import-export-buttons prefix="shift" />
                ...
                @can('shift.delete')
                <button type="button" id="shiftDestroyAllBtn" title="Permanently delete ALL shifts — cannot be undone"
        ...
        <div
            ...
            <div
                ...
                <table class="w-full text-sm text-left text-neutral-500 dark:text-neutral-400 border-collapse">
                    ...
                    <tbody id="shift-table-body" class="divide-y divide-neutral-200 dark:divide-white/5">
                       <tr>
    ...
    @include('shift.partials.shiftModal')
    @include('shift.partials.importModal')
    @endsection

@push('scripts')
  @vite(['resources/js/shift/shift.js'])
@endpush
