<div id="rosterModal"
    ...
    <div id="rosterModalCard"
        ...
        <div class="px-6 pt-4 space-y-3 shrink-0">
            <p class="text-xs text-neutral-500 dark:text-neutral-400">Type a score and click away (or press Tab) to save it — each cell saves on its own. A saved value shows here on reload, so you can always see what's already entered.</p>
