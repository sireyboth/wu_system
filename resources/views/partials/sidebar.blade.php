...
<style>
    #main-content {
        ...
        /* Large top padding on mobile for the header bar */
        width: 100%;
    }
    ...
    @media (min-width: 640px) {
        #main-content {
            padding-top: 1.5rem;
            /* Return to uniform padding on desktop viewports */
        }
...
<header id="mobile-top-bar"
    ...
    <div class="flex items-center space-x-3">
        <div
            class="flex items-center justify-center rounded-circle w-8 h-8 text-xs font-bold text-white rounded-lg bg-gradient-to-tr from-slate-900 to-indigo-950 dark:from-indigo-600 dark:to-violet-500">
            R
        </div>
            ...
            <div class="flex-1 pr-1 overflow-y-auto custom-scrollbar">
                <ul class="space-y-2 font-medium">
                    ...
                    <x-sidebar-link route="StudentStatusCertificate.index">
                        <x-slot name="icon">
                            <svg class="w-5 h-5 transition-all duration-200 ease-in-out hover:-translate-y-0.5 group-hover:-translate-y-0.5 hover:text-indigo-500 group-hover:text-indigo-500" fill="none" stroke="currentColor" viewBox="0 0 24 24" stroke-width="2">
                    ...
                    {{-- ================ Stundent Section =================== --}}
                    <x-core.label-heading label="Statistic" />
                    ...
                    <x-core.action-link route="student.snapshot" label="Snapshot" icon="user-action" />


                    <x-core.label-heading label="Academics" />
                    ...
                    <x-sidebar-link route="group.index">
                        <x-slot name="icon">
                            <svg class="w-5 h-5 transition-all duration-200 ease-in-out hover:scale-105 group-hover:scale-105 hover:text-indigo-500 group-hover:text-indigo-500" fill="none" stroke="currentColor" viewBox="0 0 24 24" stroke-width="2">
...
<button id="sidebar-open-tab" onclick="toggleSidebar()" type="button" style="display: none;"
...
<script>
    var sidebarEl = document.getElementById('sidebar-multi-level-sidebar');
    var openTabEl = document.getElementById('sidebar-open-tab');
