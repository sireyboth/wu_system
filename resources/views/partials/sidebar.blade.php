<!-- Required Custom Keyframes (Add to your global CSS if not present) -->
<style>
    @keyframes shimmer {
        100% {
...
<aside id="sidebar-multi-level-sidebar"
    ...
    aria-label="Sidebar">
    <div
        class="h-full px-4 py-6 flex flex-col justify-between bg-white dark:bg-neutral-900 border-e border-neutral-200 dark:border-white/10 shadow-2xl transition-colors duration-300">

        <div class="overflow-y-auto">
            <!-- Premium Registrar Brand Header -->
            <div class="flex items-center mb-8 px-2 group cursor-pointer">
                ...
                <div
                    ...
                    <!-- Modern Registrar Abstract "R" / Document Icon -->
