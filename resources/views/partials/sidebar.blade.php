...
<header id="mobile-top-bar"
    class="fixed top-0 left-0 right-0 z-30 flex items-center justify-between px-4 h-16 bg-white dark:bg-neutral-900 border-b border-neutral-200 dark:border-white/10 shadow-sm sm:hidden transition-colors duration-300">
    <div class="flex items-center space-x-3">
        <div
            class="w-8 h-8 bg-gradient-to-tr from-slate-900 to-indigo-950 dark:from-indigo-600 dark:to-violet-500 rounded-lg flex items-center justify-center text-white text-xs font-bold">
            R
        </div>
    ...
    <button onclick="toggleSidebar()" type="button"
        class="p-2 rounded-xl text-neutral-500 hover:bg-neutral-100 dark:hover:bg-white/5 transition-colors focus:outline-none">
                    ...
                    <div class="flex items-center justify-between mb-6 pb-2 px-2 border-b border-transparent">
                        <div class="flex items-center group cursor-pointer">
                            <div
                                ...
                                <span
                                    class="absolute bottom-1.5 right-1.5 w-1.5 h-1.5 bg-emerald-400 rounded-full animate-ping opacity-75"></span>
                                <span
                                    class="absolute bottom-1.5 right-1.5 w-1.5 h-1.5 bg-emerald-400 rounded-full"></span>
                            </div>
                        ...
                        <div class="flex-1 overflow-y-auto custom-scrollbar pr-1">
                            <ul class="space-y-2 font-medium">
                                ...
                                <li class="pt-4 pb-1">
                                    <span
                                        class="px-3 text-xs font-semibold text-neutral-400 dark:text-neutral-500 uppercase tracking-wider">Certificate</span>
                                </li>
                        ...
                        <button onclick="toggleDarkMode()"
                            ...
                            <div class="flex items-center">
                                ...
                                <svg id="theme-icon-sun"
                                    class="w-5 h-5 text-amber-500 hidden dark:block transition-transform group-hover:rotate-45"
                                    fill="none" stroke="currentColor" viewBox="0 0 24 24" stroke-width="2">
                                    <path stroke-linecap="round" stroke-linejoin="round"
