...
<body class="relative min-h-screen text-neutral-900 dark:text-white transition-colors">
    ...
    <script>
        window.addEventListener('load', function () {
            // Deferred to 'load' (and webfont-ready) so the observer measures
            // the settled layout — starting any earlier can catch a shorter,
            // pre-font page and fire immediately even though the footer is
            // actually off-screen.
            var start = function () {
