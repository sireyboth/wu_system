...
<head>
    ...
    <link
        href="https://fonts.googleapis.com/css2?family=Kantumruy+Pro:ital,wght@0,100..0,700;1,100..0,700&family=Khmer&family=UnifrakturMaguntia&display=swap"
        rel="stylesheet">
    ...
    <style>
        ...
        .font-khmer-muol {
            ...
            /* Simulating formal bold Khmer header script */
            font-weight: 700;
        }
        ...
        .font-certificate-content {
            ...
            font-size: 10pt;
            /* Explicitly forced user requirement */
            line-height: 1.6;
        }
    </style>
</head>
...
<body class="p-4">
    ...
    <div
        class="a4-page px-[30mm] pt-[45mm] pb-[30mm] flex flex-col justify-between font-certificate-content text-gray-900 selection:bg-amber-100">
        ...
        <div>
            ...
            <div class="mb-10 space-y-1 text-center">
                <h1 class="text-lg tracking-wide font-khmer-muol">វិញ្ញាបនបត្របណ្តោះអាសន្ន</h1>
                <h2 class="text-2xl font-normal leading-none font-gothic">Provisional Certificate</h2>
                <p class="pt-1 text-xs font-bold">វគ្គ</p>
            </div>

            <!-- Main Columns System: Perfect aligned vertical rows -->
            <div class="grid items-start grid-cols-2 gap-x-12">
                ...
                <div class="space-y-2 text-justify">
                    ...
                    <p class="pt-2 text-indent-sm">
                        បានជោគជ័យគ្រប់លក្ខខណ្ឌសាកលវិទ្យាល័យ ដើម្បីទទួលបានសញ្ញាបត្រ <strong
                            class="font-khmer-muol">បរិញ្ញាបត្ររង</strong> ជំនាញ <strong
                            class="font-khmer-muol text-[10.5pt]">គណនេយ្យ</strong>។
                    </p>
                ...
                <div class="space-y-2 text-justify">
                    ...
                    <div class="grid grid-cols-[90px_1fr] items-baseline">
                        <span>Name</span>
                        <span>: <strong class="font-sans uppercase font-bold tracking-wide text-[9.5pt] ml-1">CHENG
                                YOUPHING</strong></span>
                    </div>
                    ...
                    <p class="">
                        has successfully fulfilled all the requirements of the university to be awarded the <strong
                            class="font-serif font-bold text-[10.5pt]">Associate Degree</strong>, majoring in <strong
                            class="font-serif font-bold text-[10.5pt]">Accounting</strong>.
                    </p>
            ...
            <div class="flex flex-col items-center w-1/2 mt-8 ml-auto space-y-1 text-center">
        ...
        <div class="flex items-end justify-between pt-4 border-t border-transparent">

            <!-- Photo Frame Placement Left -->
            <div class="space-y-2 text-center">
                <div
                    class="w-[30mm] h-[40mm] border-2 border-gray-400 border-dashed flex flex-col items-center justify-center bg-gray-50 text-gray-400">
            ...
            <div class="text-right text-[8.5pt] text-gray-500 max-w-[60%] space-y-0.5 leading-tight">
                <p><strong class="text-gray-700 font-khmer-muol">កំណត់សំគាល់៖</strong> វិញ្ញាបនបត្រនេះចេញជូនតែម្តងគត់។
                </p>
                <p><strong class="font-serif font-bold text-gray-700">Note:</strong> This certificate is issued once
                    only.</p>
            </div>
