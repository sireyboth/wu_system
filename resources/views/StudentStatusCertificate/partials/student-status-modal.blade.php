...
{{-- <div id="student-status-modal"
    ...
    <div
        ...
        <form id="student-status-form" class="px-6 py-5 space-y-4 max-h-[70vh] overflow-y-auto custom-scrollbar">
            ...
            <div>
                <label
                    class="block mb-1 text-sm font-medium text-neutral-700 dark:text-neutral-300">ថកាលបរិច្ឆេទចេញសញ្ញាបត្រ(Date
                    Issue)</label>
            ...
            <div>
                <label class="block mb-1 text-sm font-medium text-neutral-700 dark:text-neutral-300">ថ្ងៃទីខ្មែរ (Khmer
                    Date - Full)</label>
                <input type="text" name="dateKh" id="dateKh" readonly placeholder="បំពេញដោយស្វ័យប្រវត្តិ"
                    class="w-full px-3 py-2 text-sm border rounded-lg border-neutral-200 dark:border-white/10 bg-neutral-50 dark:bg-white/5 dark:text-white">
            </div>
            ...
            <div>
                <label class="block mb-1 text-sm font-medium text-neutral-700 dark:text-neutral-300">ថ្ងៃទីខ្មែរ (Khmer
                    Date - Short)</label>
                <input type="text" name="shortDateKh" id="shortDateKh" readonly placeholder="បំពេញដោយស្វ័យប្រវត្តិ"
                    class="w-full px-3 py-2 text-sm border rounded-lg border-neutral-200 dark:border-white/10 bg-neutral-50 dark:bg-white/5 dark:text-white">
            </div>
            ...
            <div>
                ...
                <input type="text" name="cer_no" id="cer_no" required placeholder="លេខចេញសញ្ញាបត្រ"
                    class="w-full px-3 py-2 text-sm transition-all border rounded-lg border-neutral-300 dark:border-white/10 dark:bg-white/5 dark:text-white focus:ring-2 focus:ring-indigo-500 focus:border-indigo-500">
            </div>
        ...
        <div
            ...
            <button type="submit" form="student-status-form"
                class="px-4 py-2 text-sm font-medium text-white transition-all bg-indigo-600 rounded-lg hover:bg-indigo-700">
                រក្សាទុក (Save)
            </button>
        </div>
    </div>
