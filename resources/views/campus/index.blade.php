...
@section('content')
    ...
    <div class="space-y-4">
        <div class="flex flex-col md:flex-row md:items-center justify-between gap-4">
            <div class="relative w-full md:w-96 group">
                ...
                <form id="campusSearchForm" method="GET" action="{{ route('campus.index') }}"
                    ...
                    <input id="campusSearchInput" type="text" name="search" value="{{ request('search') }}"
        ...
        <div
            ...
            <div
                ...
                <table class="w-full text-sm text-left text-neutral-500 dark:text-neutral-400 border-collapse">
                    ...
                    <tbody id="campus-table-body" class="divide-y divide-neutral-200 dark:divide-white/5">
                       <tr>
    ...
    @include('campus.partials.campusModal')
    @endsection

@push('scripts')
  @vite(['resources/js/campus/campus.js'])
@endpush
