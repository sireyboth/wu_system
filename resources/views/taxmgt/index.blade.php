...
@section('content')
    ...
    <div class="mb-8">
        <h1 class="text-2xl font-bold text-neutral-900 dark:text-white">
            សូមស្វាគមន៍មកកាន់ទំព័រ <span class="text-indigo-700">វិក័យបត្រពន្ធដារ</span>
        </h1>
        ...
        <div class="flex flex-col md:flex-row md:items-center justify-between gap-4">
            <div class="relative w-full md:w-96 group">
                ...
                <form id="taxSearchForm" method="GET" action="{{ route('taxmgt.index') }}"
                    ...
                    <input id="taxSearchInput" type="text" name="search" value="{{ request('search') }}"
                ...
                <table class="w-full text-sm text-left text-neutral-500 dark:text-neutral-400 border-collapse">
                    <thead
                        ...
                        <tr>
                            ...
                            <th scope="col" class="px-6 py-4">At-Price</th>
                            <th scope="col" class="px-6 py-4">Total</th>
                            <th scope="col" class="px-6 py-4">Status</th>
                            <th scope="col" class="px-6 py-4 text-right">Actions</th>
                        </tr>
                    </thead>
                    <tbody id="tax-table-body" class="divide-y divide-neutral-200 dark:divide-white/5">
                       <tr>
