...
<div id="groupModal"
    ...
    <div id="modalCard"
        ...
        <!-- Form Structure -->
        <form id="addgroupForm" class="p-6 space-y-5 bg-white dark:bg-neutral-900">
            ...
            <!-- Input Row: Shortcut -->
            <div class="relative group">
                <label class="block text-xs font-semibold text-neutral-500 dark:text-neutral-400 uppercase tracking-wider mb-1.5">កូដសាស្ត្រាចារ្យ (group shortcut)</label>
