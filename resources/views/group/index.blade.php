...
@section('content')
    ...
    <x-core.page-header title="គ្រប់គ្រងក្រុម" />
    <div class="space-y-4">
        <div class="flex flex-col md:flex-row md:items-center justify-between gap-4">
            ...
            <div class="flex items-center gap-2">
                ...
                <x-ui.import-export-buttons prefix="group" />
                ...
                @can('group.delete')
                <button type="button" id="groupDestroyAllBtn" title="Permanently delete ALL groups — cannot be undone"
    ...
    @include('group.partials.importModal')
    @endsection
