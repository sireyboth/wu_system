...
{{-- Custom absence-entry modal --}}
<div id="absenceModal" class="fixed inset-0 z-[60] hidden items-center justify-center p-4 bg-neutral-900/50 dark:bg-black/70 backdrop-blur-sm transition-opacity duration-300">
    <div id="absenceModalCard"
         class="w-full max-w-sm bg-white dark:bg-neutral-900 rounded-3xl shadow-2xl border border-neutral-200/70 dark:border-white/10 overflow-hidden scale-95 opacity-0 transition-all duration-300 ease-[cubic-bezier(0.34,1.56,0.64,1)]">

        <div class="relative px-6 pt-7 pb-5 text-center bg-gradient-to-br from-indigo-600 to-indigo-800">
        ...
        <div class="flex gap-2.5 p-6 pt-0">
