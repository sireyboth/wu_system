...
@section('content')
    ...
    <x-core.page-header title="គ្រប់គ្រងសាស្ដ្រាចារ្យ" />
    <div class="space-y-4">
        <div class="flex flex-col md:flex-row md:items-center justify-between gap-4">
            <div class="relative w-full md:w-96 group">
                ...
                <form id="lecturerSearchForm" method="GET" action="{{ route('lecturer.index') }}"
                    ...
                    <input id="lecturerSearchInput" type="text" name="search" value="{{ request('search') }}"
            ...
            <div class="flex items-center gap-2">
                <x-ui.import-export-buttons prefix="lecturer" />
            ...
            @can('lecturer.delete')
            <button type="button" id="lecturerDestroyAllBtn" title="Permanently delete ALL lecturers — cannot be undone"
                ...
                <table class="w-full text-sm text-left text-neutral-500 dark:text-neutral-400 border-collapse">
                    <thead
                        ...
                        <tr>
                            ...
                            <th scope="col" class="px-6 py-4">Lecturer Code</th>
                    ...
                    <tbody id="lecturer-table-body" class="divide-y divide-neutral-200 dark:divide-white/5">
                       <tr>
    ...
    @include('lecturer.partials.importModal')
    @endsection
