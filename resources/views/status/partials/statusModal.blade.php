...
<div id="statusModal"
    ...
    <div id="modalCard"
        ...
        <div class="px-6 py-4 border-b border-neutral-100 dark:border-white/5 flex items-center justify-between bg-white dark:bg-neutral-900">
            <h3 id="modalTitle" class="text-lg font-bold text-neutral-900 dark:text-white">Create New Status</h3>
        ...
        <!-- Form Structure -->
        <form id="addstatusForm" class="p-6 space-y-5 bg-white dark:bg-neutral-900">
            ...
            <!-- Input Row: Shortcut -->
            <div class="relative group">
                <label class="block text-xs font-semibold text-neutral-500 dark:text-neutral-400 uppercase tracking-wider mb-1.5">កូដសាស្ត្រាចារ្យ (status shortcut)</label>
