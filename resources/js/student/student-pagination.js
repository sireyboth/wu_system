/**
 * Renders + wires up the #pagination-container div in student/index.blade.php.
 * Reads Laravel's standard paginated-resource `meta` shape:
...
function container() {
    return getById('pagination-container');
}
